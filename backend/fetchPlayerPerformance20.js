...
const fetchPlayerPerformance = async (playerId) => {
  const options = {
    ...
    params: {
      player_id: playerId,
      locale: 'UK',
      season_id: '2020'  // Cambiato per recuperare i dati della stagione 2022
    },
    headers: {
...
const insertPlayerPerformance = async (playerId, performanceData) => {
  ...
  try {
    const { data, error } = await supabase
      .from('players_performance_20')  // Inserimento nella tabella `players_performance_22`
