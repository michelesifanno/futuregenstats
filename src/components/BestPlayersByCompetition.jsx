  ...
  return (
    <>
      <div style={{ padding: '20px' }}>
        <Typography sx={{ fontWeight: 400, fontSize: isMobile ? '10px' : '14px', marginBottom: isMobile ? '10px' : '20px' }}>Seleziona la competizione e la categoria. Lo score è calcolato da un algoritmo che tiene conto di variabili relative alla stagione 23/24.</Typography>
