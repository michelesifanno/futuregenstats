...
import { useBestUnder } from '../utils/useBestUnder';
...
export default function BestUnder(role, age_category) {
  ...
  const { players, loading: playersLoading, error: playersError } = useBestUnder(role, filteredCompetitionIds, age_category); // Usa la lista delle competizioni
